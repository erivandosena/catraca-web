...
CREATE TABLE tipo
(
  tipo_id integer NOT NULL, -- Campo autoincremento para chave primaria da tabela.
...
CREATE TABLE turno
(
  turn_id integer NOT NULL, -- Campo autoincremento para chave primaria da tabela.
...
(
  cure_id integer NOT NULL, -- Campo autoincremento para chave primaria da tabela.
...
(
  catr_id integer NOT NULL, -- Campo autoincremento para chave primaria da tabela.
...
CREATE TABLE giro
(
  giro_id integer NOT NULL, -- Campo autoincremento para chave primaria da tabela.
...
(
  mens_id integer NOT NULL, -- Campo autoincremento para chave primaria da tabela.
...
CREATE TABLE cartao
(
  cart_id integer NOT NULL, -- Campo autoincremento para chave primaria da tabela.
...
(
  vinc_id integer NOT NULL, -- Campo autoincremento para chave primaria da tabela.
...
(
  isen_id integer NOT NULL, -- Campo autoincremento para chave primaria da tabela.
...
(
  untu_id integer NOT NULL, -- Campo autoincremento para chave primaria da tabela.
...
(
  caun_id integer NOT NULL, -- Campo autoincremento para chave primaria da tabela.
  catr_id integer NOT NULL, -- Campo para chave estrangeira da tabela catraca.
  unid_id integer NOT NULL, -- Campo para chave estrangeira da tabela unidade.
