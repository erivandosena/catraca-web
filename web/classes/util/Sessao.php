...
//			if($_SESSION['USUARIO_LOGIN']/* == $_COOKIE[md5('USUARIO_LOGIN')]*/)
	...
	/**
	 *
	 * @var int Esse cara pode acessar qualquer página. Inclusive págianas ainda em situação de homologação.
	 *     
	 */
	const NIVEL_SUPER = 2;
	/**
	 *
	 * @var int Esse acessa tudo, exceto as páginas em homologação.
