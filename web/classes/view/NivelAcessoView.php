 ...
 * responsáveis por gerar os elementos e as telas da página Nível de Acesso.
 */
class NivelAcessoView {
	
	/**
	 * Gera um formulário para busca pelo o usuário através do número do cartão.
	 */
	...
	/**
	 * Gera um formulário para alteração do nível do Usuário.
	 *
	 * @param Usuario $usuario
	 *        	Objeto Usuário com os dados do Usuário a ser alterado.
	 */
	...
	/**
	 * Gera um formulário para a busca pelo usuário através do seu nome.
	 */
