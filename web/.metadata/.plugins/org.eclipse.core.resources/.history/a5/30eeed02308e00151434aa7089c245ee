					...
					<div class="dez colunas">
						<section id="navegacao">							
							...
							<ul class="nav nav-tabs">
								<li role="presentation" class="active"><a href="#tab1" data-toggle="tab">Vinculo</a></li>								
							</ul>
								...
								<div class="tab-pane active" id="tab1">									
									<form method="post" action="" class="formulario sequencial texto-preto" >
										...
										<label for="campo-texto-1">
									        Nome: <input type="text" name="campo-texto-1" id="nome" disabled="disabled"/>
									    </label>
									    <label for="campo-texto-1">
									        CPF: <input type="text" name="campo-texto-1" id="cpf" disabled="disabled"/>
									    </label>
									    <label for="campo-texto-1">
									        RG: <input type="text" name="campo-texto-1" id="rg" disabled="disabled"/>
									    </label>
									    <label for="campo-texto-1">
									        Matrícula: <input type="text" name="campo-texto-1" id="matricula" disabled="disabled"/>
									    </label>
									    <label for="campo-texto-1">
									        Vínculo: <input type="text" name="campo-texto-1" id="vinculo" disabled="disabled"/>
									    </label>
									    <label for="campo-texto-1">
									        SIAPE: <input type="text" name="campo-texto-1" id="siape" disabled="disabled"/>
									    </label>
									    <label for="opcoes-1">
											<object class="rotulo texto-preto">Cartão(ões) vinculado(os): </object>
											<select name="opcoes-1" id="opcoes-1" class="texto-preto">
												<option value="1">123456789123456789</option>												
											</select>																					    
										</label>
									    <a href="incluir_cartao.php"><span class="icone-checkmark texto-verde2 botao" title="Incluir Cartão"> Incluir Cartão</span></a>
									    <a href="vinculo.php"><span class="icone-cross texto-vermelho2 botao" title="Cancelar"> Cancelar</span></a>									    
									</form>																				
									</div>									
								</div>								
							</div>
