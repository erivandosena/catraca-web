...
class VinculoDAO extends DAO{
	 ...
	 * Se existe é mais fácil. Vamos para o Passo adicionar Vinculo.
	 * 
	 * Se não existir, pegamos da base do SIG e adicionamos na base local. Indo para o passo de adicionar vinculo. 
	 * 
	 * Adicionar Vinculo
	 *
