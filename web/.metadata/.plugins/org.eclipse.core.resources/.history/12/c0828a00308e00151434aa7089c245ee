		...
		<div class="pagina fundo-cinza1">
			<div id="barra-governo">
			    <div class="resolucao config">
			       <div class="a-esquerda">
			          ...
			          <a href="http://acessoainformacao.unilab.edu.br/" target="_blank">Acesso Ã  informaÃ§Ã£o</a>
			       </div>
			       ...
			       <ul>
			          ...
			          <li><a href="http://www.servicos.gov.br/" target="_blank">ServiÃ§os</a></li>
			          <li><a href="http://www.planalto.gov.br/legislacao" target="_blank">LegislaÃ§Ã£o</a></li>
			...
			<div class="doze colunas banner gradiente">
				...
				<div id="acessibilidade" class="">
				    <div class="resolucao config">
				        ...
				        <a href="#rodape" tabindex="4" accesskey="4"><span>Ir para o rodapÃ© <b>4</b></a>
				    </div>
				</div>
				...
				<div id="topo" class="resolucao config">
					...
					<div class="seis colunas centralizado">
						<h1>CATRACA<br><small class="texto-branco">Controle Administrativo de TrÃ¡fego AcadÃªmico Automatizado</small></h1>
					</div>
			...
			<div id="barra" class="doze colunas fundo-azul3 alinhado-a-direita">
				<div class="config">
					...
					<a href="#"><span>Ã�rea de Imprensa |</span></a>
				</div>
			</div>		
					...
					<div class="duas colunas">					
						<div class="padding">
						    ...
						    <div id="expandir_menu" class="menu-vertical">
						        ...
						        <ol>
						            <li><a href="index.php" class="item-vertical-ativo"><span class="icone-home3"></span> <span class="item-vertical-texto">InÃ­cio</span></a></li>
						            ...
						            <li><a href="cartao.php" class="item-vertical"><span class="icone-profile"></span> <span class="item-vertical-texto">CartÃ£o</span></a></li>
						            <li><a href="relatorios.php" class="item-vertical"><span class="icone-file-text2"></span> <span class="item-vertical-texto">RelatÃ³rio</span></a></li>
									...
									<form method="post" action="" class="formulario em-linha" >
										...
										<label for="opcoes-1">
											...
											<select name="opcoes-1" id="opcoes-1" class="texto-preto">
												...
												<option value="3">MatrÃ­cula</option>							            										            
												<option value="3">Vinculo</option>
												<option value="3">SIAPE</option>
											</select>
											<input class="texto-preto" type="text" name="pesquisa" id="campo-texto-2" /><br>											    
										</label>
									</form>
											...
											<table class="tabela borda-vertical zebrada texto-preto">
												...
												<tbody>
											        <tr>
											            <td>1</td>
											            <td>Alan Cleber Morais Gomes</td>
											            ...
											            <td class="centralizado">
											            	<a href="incluir_vinculo.php"><span class="icone-checkmark texto-verde2 botao" title="Selecionar"></span></a>											            	
											            </td>
											        </tr>								        
											    </tbody>
											</table>
