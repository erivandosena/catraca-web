 ...
 * O cartуo existe. Verifica se o Tipo cooresponde. Faz UPDATE no tipo. Retorne o seu ID. 
 * O cartуo nуo existe. Cadastre e Retorne o seu ID. 
 * 
 * 
 *
 *
...
class VinculoDAO extends DAO {
	...
	/**
	 * Atravщs de um numero de cartуo iremos retornar seu verdadeiro ID. 
