					...
					<div class="dez colunas">
						<section id="navegacao">							
							...
							<ul class="nav nav-tabs">
								<li role="presentation" class="active"><a href="#tab1" data-toggle="tab">Vincular/Cancelar Cartão</a></li>								
							</ul>
							<div id="content" class="tab-content">
								<div class="tab-pane active" id="tab1">									
									<form method="post" action="" class="formulario texto-preto" >
										<div class="borda">										
										...
										<label for="campo-texto-1">
									   	...
									   	<a href=""><span class="icone-cross texto-vermelho2 botao" title="Cancelar"> Desvincular</span></a>								    
									</form>																				
									</div>									
								</div>								
							</div>
